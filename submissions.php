...
<html>
    ...
    <body>
        <nav class="notlanding">
            ...
            <div id = "leaderboard">
		<div id = "leaderheading"> Top Happys </div> 
                <div class = "leaderresults"><?php if ($resultleader->num_rows > 0) {

     			while($rowl = $resultleader->fetch_assoc()){  
				echo $rowl["text"].": ".$rowl["likes"]." likes"."<br>";
         			$submissionid = $rowl["id"];
     				}
			} else {
     				echo "0 results";
			}
    ...
    var profileid = "<?php echo $submissionid; $conn->close(); ?>";
        ...
        <div id="submissiontext">
                <div class="Textbox"><form id="submissionform" action>
                        <span class = "boxclose" id = "boxclose" onclick = 'this.parentNode.parentNode.parentNode.removeChild(this.parentNode.parentNode); javascript: location.reload(); return false;'></span>
